...
import Sidebar from '../../components/Sidebar2';  // Ensure correct import
...
function PlayStationPage() {
    ...
    const fetchGames = async () => {
        try {
            const response = await fetch(`/api/games?platform=playstation&genre=${filters.genre}`);
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-1">
                ...
                <div className="flex-1 p-6">
                    <h1 className="text-4xl font-bold mb-6">PlayStation Games</h1>
