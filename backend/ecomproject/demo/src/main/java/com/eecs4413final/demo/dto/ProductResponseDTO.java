...
public class ProductResponseDTO {
    ...
    public ProductResponseDTO(String name, String developer, String description, BigDecimal price, int stock, float saleMod, Set<Categories> categories, List<Image> images, String platform) {
        this.name = name;
    ...
    public ProductResponseDTO(String name, String developer, String description, BigDecimal price, int stock, float saleMod, Set<Categories> categories, String platform) {
        this.name = name;
        this.developer = developer;
        this.description = description;
        this.price = price;
